...
// dacht eerst dat ik al een functie moest maken dus toen had ik dit////

function numberOfCumLaude(grades, value) {
    return grades.filter((i) => (i >= value)).length;
}

console.log(numberOfCumLaude(grades,8));
...
const diplomaOne = cumLaude(grades);
const diplomaTwo = cumLaude([6, 4, 5]);
const diplomaThree = cumLaude([8, 9, 4, 6, 10]);

console.log(diplomaOne, diplomaTwo, diplomaThree);
...
const averageGradeOne = averageGrade(grades).toFixed(2);
const averageGradeTwo = averageGrade([6, 4, 5]);
const averageGradeThree = averageGrade([8, 9, 4, 6, 10]);

console.log(averageGradeOne, averageGradeTwo, averageGradeThree);
